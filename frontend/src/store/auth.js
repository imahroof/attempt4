  ...
  actions: {
    ...
    async login(email, password, router = null) {
      ...
      if (data.success) {
        ...
        this.masterPassword = password // Store master password
        this.saveState()
        if (router) {
        ...
        this.masterPassword = '' // Reset master password
        this.saveState()
      }
    },
      ...
      */
      localStorage.setItem(
        ...
        JSON.stringify({
          ...
          masterPassword: this.masterPassword // Add this line
        }),
      )
    },
  },
